...
<body>
  ...
  <div class="register-container"  style="min-height: 130vh; display: flex; align-items: center;">
    <div class="container">
              ...
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form class="user" action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="level"><i class="fas fa-cogs mr-2 text-primary"></i>Level:</label>
                        <select name="level" id="level" class="form-control" placeholder="Pilih Level...">
