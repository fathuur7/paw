                  ...
                  <?php for ($i = 1; $i <= 5; $i++) : ?>
                    <tr>
                      ...
                      <td class="align-middle">
                        <img src="../img/qr_no_meja_baru_<?= $i; ?>.png" 
                            alt="QR Code No. Meja Baru <?= $i; ?>" 
                            style="width: 50%; max-width: 200px; min-width: 100px;" 
                            class="img-fluid">
                      </td>
                      <td class="align-middle">
                        <a href="tambah_order_qr.php?no_meja=<?= $i; ?>">Link No. Meja <?= $i; ?></a>
                      </td>
                    </tr>
                  <?php endfor; ?>
                </tbody>
